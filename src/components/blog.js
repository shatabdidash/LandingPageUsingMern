...
function Blog() {
    return (
        <section class="text-gray-600 mt-20 lg:mb-20 mb-0 body-font" >
            <h2 class="flex justify-center text-lg font-bold text-violet-500">CATCH UP TO OUR POSTS</h2>
            <h1 class="flex justify-center text-4xl text-gray-900 font-normal mb-2 lg:mb-7">Recent story entries</h1>
            <div class="container px-5 py-12 lg:py-24 mx-auto flex flex-wrap">
                ...
                <div class="flex flex-col flex-wrap lg:w-1/2 lg:pl-2.5 lg:text-left text-center">
                    ...
                    <div class="rounded-lg bg-gray-100 p-2.5 flex mb-4 lg:items-start items-center">
                        ...
                        <div class="pl-5 w-2/3 h-auto">
                            <h2 class="text-2xl mb-3">Kyoto, Japan</h2>
                            <p class=" text-base">Kyoto is well known for its temples, gardens, Shinto shrines and wooden houses. It’s time to visit tokyo. <span className='text-violet-500'>view full blog...</span></p>
                        </div>
                    </div>
                    <div class="rounded-lg bg-gray-100 p-2.5 flex mb-4 lg:items-start items-center">
                        <div class="w-1/3 h-full inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5">
                        ...
                        <div class="pl-5 w-2/3 h-auto">
                            <h2 class="text-2xl mb-3">Lofoten Islands, Norway</h2>
                            <p class="text-base">Featuring razor-sharp peaks housing the arctic landscape. This astonishing island is perfect for your next postcard. <span className='text-violet-500'>view full blog...</span></p>
                        </div>
                    </div>
                </div>
            </div>
